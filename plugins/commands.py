...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movies Here⚡', url=f"https://t.me/+ktTDnW1gwBI4Y2M1"),
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton(' Join Main Channel ', url='https://t.me/+ktTDnW1gwBI4Y2M1')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
